...
if(isset($_POST["ingreso"]))
{
	...
	{
		$coneccion=mysql_connect("localhost", "user1", "user1") or die(mysql_error());
		mysql_select_db("Farmacos", $coneccion) or die(mysql_error());
		...
		$consulta=mysql_query("SELECT * FROM Productos WHERE descripcion='$valor'") or die(mysql_error());
		$registro=mysql_fetch_row($consulta);
