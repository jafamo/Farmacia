...
if($extension =="csv")
{
	...
	echo "<br>";
	//creamos la conexion
	include("../scripts/php/connectDB/conexionDB.php");


	$queryUpdate="UPDATE Productos1 INNER JOIN Productos on Productos.Codigo=Productos1.Codigo SET Productos1.precio=Productos.precio";
